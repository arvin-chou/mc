...
class Argument(object):
    ...
    :param argument: Whether the arguments default value should
        be pass to type for additional info.
    """

    def __init__(self, name, default=None, dest=None, required=False,
                 ignore=False, type=text_type, location=('json', 'values',),
                 choices=(), action='store', help=None, operators=('=',),
                 case_sensitive=True, store_missing=True, argument=None):
        self.name = name
    ...
    def convert(self, value, op):
        ...
        try:
            return self.type(value, self.name, op, self.argument)
        except TypeError:
            try:
